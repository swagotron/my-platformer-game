...
medal_img = pygame.image.load('assets/images/items/shaded_medal.png').convert_alpha()
...
def start_level():
    global setup, items, platforms, hero, enemies, stage, player, goal, all_sprites
    ...
    for loc in data['medal_locs']:
        items.add( Medal(loc[0], loc[1], medal_img))
    #Enemies  
